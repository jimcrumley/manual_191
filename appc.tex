...
\begin{center}
{\resizebox{3in}{!}{{\includegraphics{gpherrB.eps}}}}
\end{center}
...
\begin{center}
{\resizebox{5in}{!}{\rotatebox{-90}{\includegraphics{temp_disB.ps}}}}
\end{center}
%\vspace{4in}
...
\begin{center}
{\resizebox{5in}{!}{\rotatebox{-90}{\includegraphics{pressureB.ps}}}}
\end{center}
%\vspace{4in}
...
\begin{center}
{\resizebox{5in}{!}{\rotatebox{-90}{\includegraphics{pressure_logB.ps}}}}
\end{center}
%\vspace{4in}
...
\begin{center}
{\resizebox{5in}{!}{\rotatebox{-90}{\includegraphics{speedB.ps}}}}
\end{center}
%\vspace{4in}
%\special{ps:speed.ps}
...
\begin{figure}[!hbt]   %semi-log graph of pressure vs altitude
\begin{center}
{\resizebox{5in}{!}{\rotatebox{-90}{\includegraphics{speed_log_logB.ps}}}}
\end{center}
%\vspace{4in}
...
\begin{figure}[!hbt]   %semi-log graph of pressure vs altitude
\begin{center}
{\resizebox{5in}{!}{\rotatebox{-90}{\includegraphics{speed_true_log_logB.ps}}}}
\end{center}
%\vspace{4in}
%\special{ps:speed_log.ps}
