...
\begin{figure}
\begin{center}
{\resizebox{5in}{!}{{\includegraphics{projectile.app2b.eps}}}}
\end{center}
%\vspace{3in}
...
%you will need to correct the origin for horizontal distance $x$ by
%the radius of the ball, and the launch position of the ball as it leaves the
%launcher.  
%Check with your instructor if you are uncertain about this correction.  
...
%end of the launcher (so that your first (uncorrected) 
%horizontal distance is $x$ = 10 cm);
Estimate of the
...
into \WAPP.
%, and so you must
%include the uncertainty in $x$ in your least-squares fit.
...
Is your $B$ near 2?
%Compare your values for the parameters $A$ and $B$
